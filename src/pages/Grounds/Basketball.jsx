...
const response = await fetch(`${API}/api/grounds/sport/basketball`);
...
console.error("Error fetching basketball grounds:", err);
setError(true);
...
onClick={()=>navigate(`/Basketball-Details/${ground._id}`)}
...
navigate(`/Basketball-Details/${ground._id}`);

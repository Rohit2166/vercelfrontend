  ...
  useEffect(() => {
    ...
    const fetchGrounds = async () => {
      ...
      try {
        ...
        const response = await fetch(`${API}/api/grounds/sport/cricket`);
        ...
        console.error("Error fetching cricket grounds:", err);
    ...
    return (
      ...
      <div className="min-h-screen bg-gray-900 text-white flex justify-center items-center">
        ...
        <div className="text-center">
          ...
          <p className="text-xl mb-3">Loading cricket turfs...</p>

...
const response = await fetch(`${API}/api/grounds/sport/pickleball`);
...
console.error("Error fetching pickleball grounds:", err);
setError(true);
...
onClick={()=>navigate(`/Pickleball-Details/${ground._id}`)}
...
onError={(e)=>e.target.src="/pickelball.png"}
...
navigate(`/Pickleball-Details/${ground._id}`);
